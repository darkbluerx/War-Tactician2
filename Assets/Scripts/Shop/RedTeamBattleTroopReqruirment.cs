...
public class RedTeamBattleTroopReqruirment : MonoBehaviour
{
    public static RedTeamBattleTroopReqruirment Instance { get; private set; }
    ...
    [Space]
    //public GameObject[] buttonGameobjects2;
    [Space]
    ...
    //public Image[] myPurchaseButtonsImages2;
    [Space]

    [Header("Buttons")]
    public GameplayButton[] gameplayUnitButtons;
    [Space]
    //public GameplayButton[] gameplayUnitButtons2;
    [Space]
    ...
    private void OnEnable()
    {
        ...
        //for (int j = 0; j < buttonInffos.Length; j++)
        //{
        //    buttonGameobjects2[j].SetActive(true);
        //}
        ...
        //for (int i = 0; i < myPurchaseButtons2.Length; i++)
        //{
        //    int buttonIndex2 = i; // Capture the index in a local variable
        //    myPurchaseButtons2[i].onClick.RemoveAllListeners();
        //    myPurchaseButtons2[i].onClick.AddListener(() => PurchaseUnit(buttonIndex2));
        //}
    }
    ...
    public void LoadUnitInffos() //Load the unit info to the buttons (Shop canvas): images, names and costs
    {
        ...
        //    unitButtons2[j].unitNameText.text = buttonInffos[j].unitName;
        //    unitButtons2[j].unitCostText.text = buttonInffos[j].unitCost.ToString();
        //    unitButtons2[j].backgroundImage.sprite = buttonInffos[j].backgroundPicture;
        //    unitButtons2[j].unitImage.sprite = buttonInffos[j].unitPicture;
        //}
    }
}
